...
#ifndef LLM_BRIDGE__MSG__DETAIL__CHAT_MESSAGE__FUNCTIONS_H_
#define LLM_BRIDGE__MSG__DETAIL__CHAT_MESSAGE__FUNCTIONS_H_
 ...
 * )) before or use
 * llm_bridge__msg__ChatMessage__create()
 ...
 * calls
 * llm_bridge__msg__ChatMessage__init().
...
/**
 * It calls
 * llm_bridge__msg__ChatMessage__fini()
 ...
 * llm_bridge__msg__ChatMessage__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * llm_bridge__msg__ChatMessage__Sequence__fini()
 * on the array,
...
#endif  // LLM_BRIDGE__MSG__DETAIL__CHAT_MESSAGE__FUNCTIONS_H_
