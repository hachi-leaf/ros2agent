...
{
  new (message_memory) llm_bridge::msg::ContentPart(_init);
}

void ContentPart_fini_function(void * message_memory)
{
  auto typed_message = static_cast<llm_bridge::msg::ContentPart *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ContentPart_message_member_array[3] = {
  {
    ...
    offsetof(llm_bridge::msg::ContentPart, type),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(llm_bridge::msg::ContentPart, text),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(llm_bridge::msg::ContentPart, image_url),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ContentPart_message_members = {
  ...
  3,  // number of fields
  sizeof(llm_bridge::msg::ContentPart),
...
{
  return &::llm_bridge::msg::rosidl_typesupport_introspection_cpp::ContentPart_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, llm_bridge, msg, ContentPart)() {
  return &::llm_bridge::msg::rosidl_typesupport_introspection_cpp::ContentPart_message_type_support_handle;
}
