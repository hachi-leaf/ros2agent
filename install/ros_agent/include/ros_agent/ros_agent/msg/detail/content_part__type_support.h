...
#ifndef ROS_AGENT__MSG__DETAIL__CONTENT_PART__TYPE_SUPPORT_H_
#define ROS_AGENT__MSG__DETAIL__CONTENT_PART__TYPE_SUPPORT_H_
...
#endif  // ROS_AGENT__MSG__DETAIL__CONTENT_PART__TYPE_SUPPORT_H_
