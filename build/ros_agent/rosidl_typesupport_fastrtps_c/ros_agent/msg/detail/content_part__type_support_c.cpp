...
#include "ros_agent/msg/detail/content_part__rosidl_typesupport_fastrtps_c.h"
...
using _ContentPart__ros_msg_type = ros_agent__msg__ContentPart;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_agent__msg__ContentPart;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_agent__msg__ContentPart * ros_message = static_cast<const ros_agent__msg__ContentPart *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_agent__msg__ContentPart(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_agent__msg__ContentPart * ros_message = static_cast<ros_agent__msg__ContentPart *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_agent__msg__ContentPart(cdr, ros_message);
}

static uint32_t _ContentPart__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_agent__msg__ContentPart(
...
static size_t _ContentPart__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_agent__msg__ContentPart(
