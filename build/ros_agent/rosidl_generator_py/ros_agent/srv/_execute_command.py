...
class ExecuteCommand_Event(metaclass=Metaclass_ExecuteCommand_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ros_agent/ExecuteCommand_Request, 1>',
        'response': 'sequence<ros_agent/ExecuteCommand_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros_agent', 'srv'], 'ExecuteCommand_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros_agent', 'srv'], 'ExecuteCommand_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ros_agent.srv import ExecuteCommand_Request
    ...
    def response(self, value):
        if self._check_fields:
            from ros_agent.srv import ExecuteCommand_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_ExecuteCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros_agent.srv import _execute_command
...
class ExecuteCommand(metaclass=Metaclass_ExecuteCommand):
    from ros_agent.srv._execute_command import ExecuteCommand_Request as Request
    from ros_agent.srv._execute_command import ExecuteCommand_Response as Response
    from ros_agent.srv._execute_command import ExecuteCommand_Event as Event
