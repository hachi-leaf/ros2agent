...
static const _ContentPart_type_support_symbol_names_t _ContentPart_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_agent, msg, ContentPart)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_agent, msg, ContentPart)),
  }
};
...
{
  return &::ros_agent::msg::rosidl_typesupport_cpp::ContentPart_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros_agent, msg, ContentPart)() {
  return get_message_type_support_handle<ros_agent::msg::ContentPart>();
}
