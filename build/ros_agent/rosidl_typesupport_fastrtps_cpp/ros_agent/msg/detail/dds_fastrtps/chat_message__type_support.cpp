...
#include "ros_agent/msg/detail/chat_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros_agent::msg::ContentPart &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ros_agent::msg::ContentPart &);
...
cdr_serialize(
  const ros_agent::msg::ChatMessage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_agent::msg::ChatMessage & ros_message)
{
  // Member: role
  cdr >> ros_message.role;
  ...
  size_t current_alignment)
{
  ...
  // Member: parts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_agent::msg::typesupport_fastrtps_cpp::max_serialized_size_ContentPart(
  ...
  if (is_plain) {
    ...
    using DataType = ros_agent::msg::ChatMessage;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: parts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_agent::msg::typesupport_fastrtps_cpp::max_serialized_size_key_ContentPart(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const ros_agent::msg::ChatMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_agent::msg::ChatMessage *>(
    untyped_ros_message);
...
{
  return &ros_agent::msg::typesupport_fastrtps_cpp::_ChatMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_agent, msg, ChatMessage)() {
  return &ros_agent::msg::typesupport_fastrtps_cpp::_ChatMessage__handle;
}
