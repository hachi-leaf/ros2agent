...
static const _ExecuteCommand_Request_type_support_symbol_names_t _ExecuteCommand_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, command_executor, srv, ExecuteCommand_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, command_executor, srv, ExecuteCommand_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, command_executor, srv, ExecuteCommand_Request)() {
  return &::command_executor::srv::rosidl_typesupport_c::ExecuteCommand_Request_message_type_support_handle;
}
...
static const _ExecuteCommand_Response_type_support_symbol_names_t _ExecuteCommand_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, command_executor, srv, ExecuteCommand_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, command_executor, srv, ExecuteCommand_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, command_executor, srv, ExecuteCommand_Response)() {
  return &::command_executor::srv::rosidl_typesupport_c::ExecuteCommand_Response_message_type_support_handle;
}
...
static const _ExecuteCommand_Event_type_support_symbol_names_t _ExecuteCommand_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, command_executor, srv, ExecuteCommand_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, command_executor, srv, ExecuteCommand_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, command_executor, srv, ExecuteCommand_Event)() {
  return &::command_executor::srv::rosidl_typesupport_c::ExecuteCommand_Event_message_type_support_handle;
}
...
static const _ExecuteCommand_type_support_symbol_names_t _ExecuteCommand_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, command_executor, srv, ExecuteCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, command_executor, srv, ExecuteCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, command_executor, srv, ExecuteCommand)() {
  return &::command_executor::srv::rosidl_typesupport_c::ExecuteCommand_service_type_support_handle;
}
