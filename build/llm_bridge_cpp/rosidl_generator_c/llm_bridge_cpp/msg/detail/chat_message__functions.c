...
llm_bridge_cpp__msg__ChatMessage__init(llm_bridge_cpp__msg__ChatMessage * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->role)) {
    llm_bridge_cpp__msg__ChatMessage__fini(msg);
    return false;
  }
  // parts
  if (!llm_bridge_cpp__msg__ContentPart__Sequence__init(&msg->parts, 0)) {
    llm_bridge_cpp__msg__ChatMessage__fini(msg);
    return false;
  }
  return true;
...
llm_bridge_cpp__msg__ChatMessage__fini(llm_bridge_cpp__msg__ChatMessage * msg)
{
  ...
  // parts
  llm_bridge_cpp__msg__ContentPart__Sequence__fini(&msg->parts);
}
...
llm_bridge_cpp__msg__ChatMessage__are_equal(const llm_bridge_cpp__msg__ChatMessage * lhs, const llm_bridge_cpp__msg__ChatMessage * rhs)
{
  ...
  // parts
  if (!llm_bridge_cpp__msg__ContentPart__Sequence__are_equal(
      &(lhs->parts), &(rhs->parts)))
  {
    return false;
  }
  ...
  llm_bridge_cpp__msg__ChatMessage * output)
{
  ...
  // parts
  if (!llm_bridge_cpp__msg__ContentPart__Sequence__copy(
...
llm_bridge_cpp__msg__ChatMessage__create(void)
{
  ...
  llm_bridge_cpp__msg__ChatMessage * msg = (llm_bridge_cpp__msg__ChatMessage *)allocator.allocate(sizeof(llm_bridge_cpp__msg__ChatMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(llm_bridge_cpp__msg__ChatMessage));
  bool success = llm_bridge_cpp__msg__ChatMessage__init(msg);
  if (!success) {
...
llm_bridge_cpp__msg__ChatMessage__Sequence__init(llm_bridge_cpp__msg__ChatMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  llm_bridge_cpp__msg__ChatMessage * data = NULL;

  if (size) {
    data = (llm_bridge_cpp__msg__ChatMessage *)allocator.zero_allocate(size, sizeof(llm_bridge_cpp__msg__ChatMessage), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = llm_bridge_cpp__msg__ChatMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        llm_bridge_cpp__msg__ChatMessage__fini(&data[i - 1]);
      }
...
llm_bridge_cpp__msg__ChatMessage__Sequence__fini(llm_bridge_cpp__msg__ChatMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      llm_bridge_cpp__msg__ChatMessage__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  llm_bridge_cpp__msg__ChatMessage__Sequence * array = (llm_bridge_cpp__msg__ChatMessage__Sequence *)allocator.allocate(sizeof(llm_bridge_cpp__msg__ChatMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = llm_bridge_cpp__msg__ChatMessage__Sequence__init(array, size);
  if (!success) {
...
llm_bridge_cpp__msg__ChatMessage__Sequence__destroy(llm_bridge_cpp__msg__ChatMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    llm_bridge_cpp__msg__ChatMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
llm_bridge_cpp__msg__ChatMessage__Sequence__are_equal(const llm_bridge_cpp__msg__ChatMessage__Sequence * lhs, const llm_bridge_cpp__msg__ChatMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!llm_bridge_cpp__msg__ChatMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  llm_bridge_cpp__msg__ChatMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(llm_bridge_cpp__msg__ChatMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    llm_bridge_cpp__msg__ChatMessage * data =
      (llm_bridge_cpp__msg__ChatMessage *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!llm_bridge_cpp__msg__ChatMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          llm_bridge_cpp__msg__ChatMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!llm_bridge_cpp__msg__ChatMessage__copy(
