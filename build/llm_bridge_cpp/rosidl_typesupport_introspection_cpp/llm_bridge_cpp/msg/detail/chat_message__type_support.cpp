...
{
  new (message_memory) llm_bridge_cpp::msg::ChatMessage(_init);
}

void ChatMessage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<llm_bridge_cpp::msg::ChatMessage *>(message_memory);
  typed_message->~ChatMessage();
}

size_t size_function__ChatMessage__parts(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<llm_bridge_cpp::msg::ContentPart> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<llm_bridge_cpp::msg::ContentPart> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<llm_bridge_cpp::msg::ContentPart> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const llm_bridge_cpp::msg::ContentPart *>(
    get_const_function__ChatMessage__parts(untyped_member, index));
  auto & value = *reinterpret_cast<llm_bridge_cpp::msg::ContentPart *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<llm_bridge_cpp::msg::ContentPart *>(
    get_function__ChatMessage__parts(untyped_member, index));
  const auto & value = *reinterpret_cast<const llm_bridge_cpp::msg::ContentPart *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ChatMessage_message_member_array[2] = {
  {
    ...
    offsetof(llm_bridge_cpp::msg::ChatMessage, role),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<llm_bridge_cpp::msg::ContentPart>(),  // members of sub message
    false,  // is key
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(llm_bridge_cpp::msg::ChatMessage, parts),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ChatMessage_message_members = {
  ...
  2,  // number of fields
  sizeof(llm_bridge_cpp::msg::ChatMessage),
...
{
  return &::llm_bridge_cpp::msg::rosidl_typesupport_introspection_cpp::ChatMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, llm_bridge_cpp, msg, ChatMessage)() {
  return &::llm_bridge_cpp::msg::rosidl_typesupport_introspection_cpp::ChatMessage_message_type_support_handle;
}
