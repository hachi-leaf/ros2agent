...
class Metaclass_Chat_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('llm_bridge_cpp')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'llm_bridge_cpp.action.Chat_Goal')
            logger.debug(
            ...
            from llm_bridge_cpp.msg import ChatMessage
...
class Chat_Goal(metaclass=Metaclass_Chat_Goal):
    ...
    _fields_and_field_types = {
        'messages': 'sequence<llm_bridge_cpp/ChatMessage>',
        'stream': 'boolean',
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['llm_bridge_cpp', 'msg'], 'ChatMessage')),  # noqa: E501
...
class Metaclass_Chat_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'llm_bridge_cpp.action.Chat_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Chat_Result(metaclass=Metaclass_Chat_Result):
    ...
    _fields_and_field_types = {
        ...
        'updated_messages': 'sequence<llm_bridge_cpp/ChatMessage>',
        'success': 'boolean',
        'error_msg': 'string',
        'prompt_tokens': 'int32',
...
class Metaclass_Chat_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'llm_bridge_cpp.action.Chat_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Chat_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from llm_bridge_cpp.action import Chat
...
class Chat_SendGoal_Request(metaclass=Metaclass_Chat_SendGoal_Request):
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['llm_bridge_cpp', 'action'], 'Chat_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from llm_bridge_cpp.action._chat import Chat_Goal
...
class Chat_SendGoal_Event(metaclass=Metaclass_Chat_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<llm_bridge_cpp/Chat_SendGoal_Request, 1>',
        'response': 'sequence<llm_bridge_cpp/Chat_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['llm_bridge_cpp', 'action'], 'Chat_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['llm_bridge_cpp', 'action'], 'Chat_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from llm_bridge_cpp.action import Chat_SendGoal_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from llm_bridge_cpp.action import Chat_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_Chat_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'llm_bridge_cpp.action.Chat_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from llm_bridge_cpp.action import _chat
...
class Chat_SendGoal(metaclass=Metaclass_Chat_SendGoal):
    from llm_bridge_cpp.action._chat import Chat_SendGoal_Request as Request
    from llm_bridge_cpp.action._chat import Chat_SendGoal_Response as Response
    from llm_bridge_cpp.action._chat import Chat_SendGoal_Event as Event
...
class Chat_GetResult_Response(metaclass=Metaclass_Chat_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'llm_bridge_cpp/Chat_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['llm_bridge_cpp', 'action'], 'Chat_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from llm_bridge_cpp.action._chat import Chat_Result
...
class Chat_GetResult_Event(metaclass=Metaclass_Chat_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<llm_bridge_cpp/Chat_GetResult_Request, 1>',
        'response': 'sequence<llm_bridge_cpp/Chat_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['llm_bridge_cpp', 'action'], 'Chat_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['llm_bridge_cpp', 'action'], 'Chat_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from llm_bridge_cpp.action import Chat_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from llm_bridge_cpp.action import Chat_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_Chat_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'llm_bridge_cpp.action.Chat_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Chat_GetResult(metaclass=Metaclass_Chat_GetResult):
    from llm_bridge_cpp.action._chat import Chat_GetResult_Request as Request
    from llm_bridge_cpp.action._chat import Chat_GetResult_Response as Response
    from llm_bridge_cpp.action._chat import Chat_GetResult_Event as Event
...
class Metaclass_Chat_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'llm_bridge_cpp.action.Chat_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Chat_FeedbackMessage(metaclass=Metaclass_Chat_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'llm_bridge_cpp/Chat_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['llm_bridge_cpp', 'action'], 'Chat_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from llm_bridge_cpp.action._chat import Chat_Feedback
...
class Chat(metaclass=Metaclass_Chat):
    ...
    from llm_bridge_cpp.action._chat import Chat_Goal as Goal
    # The result message defined in the action definition.
    from llm_bridge_cpp.action._chat import Chat_Result as Result
    # The feedback message defined in the action definition.
    from llm_bridge_cpp.action._chat import Chat_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from llm_bridge_cpp.action._chat import Chat_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from llm_bridge_cpp.action._chat import Chat_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from llm_bridge_cpp.action._chat import Chat_FeedbackMessage as FeedbackMessage
