...
static const _ContentPart_type_support_symbol_names_t _ContentPart_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, llm_bridge_cpp, msg, ContentPart)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, llm_bridge_cpp, msg, ContentPart)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, llm_bridge_cpp, msg, ContentPart)() {
  return &::llm_bridge_cpp::msg::rosidl_typesupport_c::ContentPart_message_type_support_handle;
}
