...
#include "llm_bridge_cpp/msg/detail/content_part__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = llm_bridge_cpp::msg::ContentPart;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const llm_bridge_cpp::msg::ContentPart *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<llm_bridge_cpp::msg::ContentPart *>(
    untyped_ros_message);
...
{
  return &llm_bridge_cpp::msg::typesupport_fastrtps_cpp::_ContentPart__handle;
}
