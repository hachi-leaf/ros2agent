...
static const _ChatMessage_type_support_symbol_names_t _ChatMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, llm_bridge, msg, ChatMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, llm_bridge, msg, ChatMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, llm_bridge, msg, ChatMessage)() {
  return &::llm_bridge::msg::rosidl_typesupport_c::ChatMessage_message_type_support_handle;
}
