...
#include "llm_bridge/msg/detail/chat_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const llm_bridge::msg::ContentPart &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  llm_bridge::msg::ContentPart &);
...
cdr_serialize(
  const llm_bridge::msg::ChatMessage & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  llm_bridge::msg::ChatMessage & ros_message)
{
  // Member: role
  cdr >> ros_message.role;
  ...
  size_t current_alignment)
{
  ...
  // Member: parts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        llm_bridge::msg::typesupport_fastrtps_cpp::max_serialized_size_ContentPart(
  ...
  if (is_plain) {
    ...
    using DataType = llm_bridge::msg::ChatMessage;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: parts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        llm_bridge::msg::typesupport_fastrtps_cpp::max_serialized_size_key_ContentPart(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const llm_bridge::msg::ChatMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<llm_bridge::msg::ChatMessage *>(
    untyped_ros_message);
...
{
  return &llm_bridge::msg::typesupport_fastrtps_cpp::_ChatMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, llm_bridge, msg, ChatMessage)() {
  return &llm_bridge::msg::typesupport_fastrtps_cpp::_ChatMessage__handle;
}
