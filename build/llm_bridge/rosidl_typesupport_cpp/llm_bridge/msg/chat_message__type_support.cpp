...
static const _ChatMessage_type_support_symbol_names_t _ChatMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, llm_bridge, msg, ChatMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, llm_bridge, msg, ChatMessage)),
  }
};
...
{
  return &::llm_bridge::msg::rosidl_typesupport_cpp::ChatMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, llm_bridge, msg, ChatMessage)() {
  return get_message_type_support_handle<llm_bridge::msg::ChatMessage>();
}
