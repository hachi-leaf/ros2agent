...
#include "llm_bridge/msg/detail/chat_message__rosidl_typesupport_fastrtps_c.h"
...
#include "llm_bridge/msg/detail/content_part__functions.h"  // parts
...
using _ChatMessage__ros_msg_type = llm_bridge__msg__ChatMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: parts
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_llm_bridge__msg__ContentPart(
        &array_ptr[i], cdr);
    }
  }
  ...
  llm_bridge__msg__ChatMessage * ros_message)
{
  ...
  // Field name: parts
  {
    ...
    if (ros_message->parts.data) {
      llm_bridge__msg__ContentPart__Sequence__fini(&ros_message->parts);
    }
    if (!llm_bridge__msg__ContentPart__Sequence__init(&ros_message->parts, size)) {
      fprintf(stderr, "failed to create array for field 'parts'");
      return false;
    }
    auto array_ptr = ros_message->parts.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_llm_bridge__msg__ContentPart(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: parts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_llm_bridge__msg__ContentPart(
  ...
  size_t current_alignment)
{
  ...
  // Field name: parts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_llm_bridge__msg__ContentPart(
  ...
  if (is_plain) {
    ...
    using DataType = llm_bridge__msg__ChatMessage;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: parts
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_llm_bridge__msg__ContentPart(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: parts
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_llm_bridge__msg__ContentPart(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: parts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_llm_bridge__msg__ContentPart(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const llm_bridge__msg__ChatMessage * ros_message = static_cast<const llm_bridge__msg__ChatMessage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_llm_bridge__msg__ChatMessage(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  llm_bridge__msg__ChatMessage * ros_message = static_cast<llm_bridge__msg__ChatMessage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_llm_bridge__msg__ChatMessage(cdr, ros_message);
}

static uint32_t _ChatMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_llm_bridge__msg__ChatMessage(
...
static size_t _ChatMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_llm_bridge__msg__ChatMessage(
